<?php 
	...
	// connect to database
	$db = mysqli_connect('localhost', 'root', '', 'itc');
	...
	if (isset($_POST['reg_user'])) {
		...
		if (count($errors) == 0) {
			...
			$query = "INSERT INTO registration (EmpId,UserId, Email, password,password_1) 
	...
	if (isset($_POST['login_user'])) {
		...
		if (count($errors) == 0) {
			...
			$query = "SELECT * FROM registration WHERE EmpId='$EmpId' AND password='$password'";
